...
export default {
  ...
  methods: {
      ...
      this.$api
        ...
        .then(res => {
          ...
          this.arr = res.goods.comment;
            ...
            // 最近浏览
    this.vex.push(JSON.parse(localStorage.getItem("browse"))) 
    ...
    if(a===null){
      ...
      localStorage.setItem("browse",JSON.stringify(this.msg))
    }else if(this.vex.length===1){
     this.some=JSON.parse(localStorage.getItem("browse"))
     this.some1.push(this.some)
 
    // console.log(this.some1)
    this.some2.push(this.msg)
    
    //  console.log(this.some2)
   this.some3=this.some1.concat(this.some2)
    //  this.some2.push(tvb)
    //  console.log(this.some3)
     localStorage.setItem("browse",JSON.stringify(this.some3))
 
    }else if(this.vex.length===2||this.vex.length>2){
       this.some=JSON.parse(localStorage.getItem("browse"))
    //  this.some1=this.some
