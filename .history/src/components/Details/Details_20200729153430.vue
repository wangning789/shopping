 ...
 <div>
    <div>
        ...
        <van-swipe class="my-swipe" :autoplay="3000" indicator-color="orange" >
            <van-swipe-item @click="open"><div class="box"><img :src="this.msg.image_path" alt=""></div></van-swipe-item>
            <van-swipe-item @click="open"><div class="box"> <img :src="this.msg.image_path" alt=""></div></van-swipe-item>
        </van-swipe>
        <!-- 商品信息和价格 -->
        <div class="box1">
        ...
        <!-- 详情和评论 -->
        <van-tabs v-model="active" @click="clickpinglun">
  <van-tab title="商品详情">
      ...
      <div></div>
       ...
       <!-- 购买弹处框 -->
        <van-popup v-model="show"  position="bottom"  close-icon="close"   closeable>
            <div class="tanchu">
                <div class="yiwa">
                    <div class="erwa"><img :src="this.msg.image_path"></div>
                    <div class="sanwa">
                ...
                <div class="siwa">
                   ...
                   <div class="jiuwa"> <van-stepper v-model="value" min="0" max="10" /></div>
                </div>
                 <div><van-button class="goumai" type="danger" text="立即购买" @click="clickbuy" /></div>
            </div>
...
import { Toast } from 'vant';
 ...
 this.msg.image_path,
  this.msg.image_path
    ...
    //   查询评论 
    getDatacha(id,_id){
        this.$api.LoginseesData({id:id,_id:_id}).then(res=>{
            console.log(res)
        }).catch()
    },
