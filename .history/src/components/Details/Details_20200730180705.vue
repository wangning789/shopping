...
export default {
  ...
  methods: {
    ...
    }else if(this.some.length<2){
     let arr= JSON.parse(localStorage.getItem("browse"))
     localStorage.removeItem("browse")

     this.some.push(arr)
     this.some.push(this.msg)
    
     localStorage.setItem("browse",JSON.stringify(this.some))
    }else if(this.some.length===2||this.some.length>2){
      let bbc= JSON.parse(localStorage.getItem("browse"))
      bbc.push(this.msg)
      localStorage.setItem("browse",JSON.stringify(bbc))
    }
