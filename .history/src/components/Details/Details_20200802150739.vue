...
export default {
  ...
  methods: {
    ...
    if(a===null){
     ...
     let acc=(JSON.parse(localStorage.getItem("browse")))
     this.some.push(acc)
    //  this.some1.push(this.msg)
    console.log(this.some)
    this.some1.pusn(JSON.stringify(this.msg))
    //  this.some.push(JSON.stringify(this.msg))
     console.log(this.some1)
     
        // let bbc=this.some1.concat(this.some)
    //  localStorage.setItem("browse",JSON.stringify(this.some1))
    }
