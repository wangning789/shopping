 ...
 <div>
  ...
  <van-tab title="商品评论"></van-tab>
       ...
       <van-goods-action>
            ...
            <van-goods-action-button type="warning" text="加入购物车" @click="getDatacat"/>
        ...
        <van-popup v-model="show"  position="bottom"  close-icon="close"   closeable>
            <div class="tanchu">
                ...
                <div class="siwa">
                 ...
                 <div><van-button class="goumai" type="danger" text="立即购买" /></div>
            </div>
