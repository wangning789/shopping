 ...
 <div>
    <div>
        ...
        <van-swipe class="my-swipe" :autoplay="3000" indicator-color="orange">
            <van-swipe-item @click="cvb"><div class="box"><img :src="this.msg.image_path" alt=""></div></van-swipe-item>
            <van-popup v-model="lunbo"><div><img :src="this.msg.image_path" alt=""></div></van-popup>
