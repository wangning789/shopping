<template>
 <div>
    ...
    <div class="box2">
        <!-- 没有默认地址时候显示 -->
        <div v-if="this.dizhi.areaCode>0" @click="tianjia" class="box3">点击添加收获地址</div>
        <!-- 有默认地址时候显示 -->
        <div v-if="this.dizhi===true" class="max">
...
import { Toast } from 'vant';
 export default {
   ...
   mounted() {
       ...
       this.number=Number(sessionStorage.getItem("number"))
       this.dizhi1=JSON.parse(sessionStorage.getItem("dizhi"))
            this.getData()
