         ...
         <div class="box5">
            ...
            <div class="box6">
              <van-field v-model="Verification" label="验证码" placeholder="验证码">
                <template #button>
                  <div v-html="msg" @click="getData2"></div>
                </template>
              </van-field>
            </div>
         </div>
            ...
            <div style="margin: 16px;" class="box4">
              <van-button type="info" native-type="submit" @click="getData1">登陆</van-button>
              <van-button type="danger" native-type="submit" @click="getData">注册</van-button>
            </div>
          </van-form>
        </div>
      </div>
       ...
       this.$api
        ...
        .then(res => {
          if(res.code===200){
           ...
           localStorage.setItem("usa",this.username)
           this.$router.push("/")
           console.log(res)
          }else{
            this.$toast(res.msg)
