...
export default {
  ...
  methods: {
    ...
    this.image.push(this.im)
    this.getData(id,rate,content,anonymous,_id,order_id,this.image)
   ...
   getData(id,rate,content,anonymous,_id,order_id,image){
       this.$api.CommentData({id:id,rate:rate,content:content,anonymous:anonymous,_id:id,order_id:order_id,image:image}).then(res=>{
           console.log(res)
       }).catch()
   }
  },
