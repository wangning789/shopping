...
export default {
  ...
  methods: {
    ...
    let order=this.msg.order_id
    this.getData(id,rate,content,anonymous,_id,order_id)
   ...
   getData(id,rate,content,anonymous,_id,order_id){
       this.$api.CommentData({id:id,rate:rate,content:content,anonymous:anonymous,_id:id,order_id:order_id}).then(res=>{
           console.log(res)
       }).catch()
   }
  },
