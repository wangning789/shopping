<template>
  <div>
    ...
    <div>
      ...
      <div class="max">
        <div>
          <van-checkbox v-model="checked" checked-color="#D53F3A" shape="square"  @change="changeAll(item,index)">
      ...
      <div v-for="(item,index) in msg" :key="index">
          <div class="max3">
              <div><van-checkbox  v-model="item.check" checked-color="#D53F3A" shape="square" @change="changedan"></van-checkbox></div>
