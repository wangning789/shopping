<template>
  <div>
    <!-- 在没有登陆的情况下 -->
    <div>
      <div class="grf"><img src="../../../loading.gif" class="grf"></div>
      <div class="Logingo" @click="Login"><van-button round type="default">请登陆</van-button></div>
    </div>
    ...
    <div v-if="badge>0">
      ...
      <div class="max2" >
        <div v-if="num===-1">
          <van-button type="danger" @click="clickshanchu">删除</van-button>
        </div>
        <div v-if="num===-1">
          <van-button type="warning" @click="clickend">去结算</van-button>
        </div>
      </div>
            <!-- 购物车的商品 -->
      <div v-for="(item,index) in msg" :key="index">
          <div class="max3">
              ...
              <div class="max6">
                  <div>{{item.name}}</div>
                  <div class="max7">
                      <div class="max8">¥{{item.mallPrice*item.count | sunn}}</div>
                      <div class="suan">
