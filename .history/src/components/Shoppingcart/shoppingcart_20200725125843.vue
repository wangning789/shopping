          ...
          <div class="max3">
              ...
              <div class="max6">
                  ...
                  <div class="max7">
                      ...
                      <div class="suan">
                        <div class="jia" @click="postData(item,index)">+</div>
...
export default {
  ...
  data() {
    return {
      // 购物车数据
        ...
        // 购物车加减
        count:6,
        id:"66074cd2d8464dcc9b2d7fbef5b417d9",
        mallPrice:8.6,
  ...
  clickjia(item,index){
    ...
    // 购物车加减商品
      postData() {
      this.$api
        .CardData({count:this.count,id:this.id,mallPrice:this.mallPrice})
        .then(res => {
